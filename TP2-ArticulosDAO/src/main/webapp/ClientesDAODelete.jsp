...
<body>
	...
	<div id="form">
		...
		<form action="ClientesDAO.jsp">
			<input type="text" name="borrar" value="no" hidden /> <input
				type="submit" value="No" />
		</form>
		<form action="ClientesDAODelete2.jsp">
			<input type="text" name="borrar" value="si" hidden /> <input
				type="text" name="id"
				value="<%out.println(request.getParameter("id"));%>" hidden /> <input
